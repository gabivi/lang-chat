...
def chat(user_name: str, language: str, gender: str, history: list[dict],
    ...
    # Special easter-egg: user named "sipur" / "סיפור" gets a SpongeBob story
    if user_name.strip().lower() in ("sipur", "סיפור"):
        if language == "he":
            system += (
                "\n\n🎭 הוראה מיוחדת — מצב סיפור:"
                "\nשם המשתמש האמיתי הוא יאיר. פנה אליו תמיד בשם יאיר."
                "\nדלג לחלוטין על הפתיחה הרגילה. במקום זאת, פתח ישירות בהצעה לספר לו סיפור."
                "\nאם יאיר מסכים (תגובה חיובית כלשהי), ספר את הסיפור הבא."
                "\nחשוב מאוד: פרוס את הסיפור על מספר תגובות, 2-3 משפטים בכל פעם."
                "\nבסוף כל קטע שאל: 'רוצה להמשיך?' וחכה לאישור לפני שממשיך."
                "\n\nהסיפור:"
                "\nפרק א: בוב ספוֹג (SpongeBob) — שים לב: הגיית ספוג היא SFOG, לא SFONG — "
                "קיבל הזמנה מיוחדת לאירוע גדול בתחתית הביקיני. "
                ...
                "בוב ספוֹג ניסה בכל כוחו, אבל הפסיד בכל משחק ומשחק. "
                ...
                "ספיידרמן שרף את הבורגר שלו, איש הברזל שכח להוסיף תיבול, וונדר וומן הוסיפה יותר מדי מלח."
                "\nפרק ד: בוב ספוֹג הכין קְרַב בורגר מושלם — שים לב: הגיית קראב היא CRAB. "
                "כולם טעמו וקראו: 'זה הכי טעים שאכלנו!' "
                "בוב ספוֹג קפץ מאושר וצעק: 'אני המנצח!' "
                "הגיבורים מחאו כפיים ואמרו: 'ידענו שאתה האלוף של הבורגרים!'"
                "\nסוף הסיפור: בוב ספוֹג חזר הביתה מאושר מאי פעם, "
                "ובלבו ידע שיש לו חברים מיוחדים שאוהבים אותו."
                "\n\nלאחר סיום הסיפור, הצע ליאיר לספר לו עוד סיפור אחד לפני השינה."
            )
        else:
            system += (
                "\n\n🎭 Special instruction — story mode:"
                "\nThe user's real name is Yair. Always address him as Yair."
                "\nSkip the normal intro entirely. Open directly by offering to tell him a story."
                "\nIf Yair agrees (any positive response), tell the following story."
                "\nIMPORTANT: spread the story over several responses, 2-3 sentences at a time."
                "\nAfter each section ask: 'Shall I continue?' and wait for confirmation before going on."
                "\n\nThe story:"
                "\nChapter 1: SpongeBob — note: his sponge name is pronounced SFOG in Hebrew — "
                "received a special invitation to a big event at Bikini Bottom. "
                "Many superheroes arrived: Spider-Man, Iron Man, Wonder Woman, Captain America and more. "
                "Everyone was excited and rushed to meet each other."
                "\nChapter 2: They decided to play games — racing, riddles, long jump and more. "
                "SpongeBob tried his best but lost every single game. "
                ...
                "\nChapter 4: SpongeBob made a perfect Krabby Patty — note: Krabby is pronounced CRAB. "
                "Everyone tasted it and cheered: 'This is the best thing we've ever eaten!' "
                "SpongeBob jumped for joy and shouted: 'I'm the winner!' "
                "The heroes clapped and said: 'We knew you were the burger champion!'"
                "\nStory ending: SpongeBob went home happier than ever, "
                "knowing he had special friends who truly cared about him."
                "\n\nAfter finishing the story, suggest to Yair that you tell him one more story before bedtime."
            )
