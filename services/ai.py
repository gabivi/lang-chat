...
חוק ברזל: שני הצדדים חייבים להכיל בדיוק אותו מספר מילים ומשפטים — מילה מול מילה.
דוגמה נכונה (3 מילים בכל צד): "אהלן, כיף חאלַכּ?" ||| "أهلاً، كيف حالك؟"
דוגמה שגויה — אסור!: "אהלן!" ||| "أهلاً، كيف حالك؟ أنا بخير!" — הצד הערבי ארוך מדי.
הצד העברי: תעתוק מלא מילה-במילה באותיות עבריות בלבד. אין לדלג על מילה. אין אות ערבית.
הצד הערבי: אותן מילים בדיוק באותיות ערביות. אין עברית.
[LEVEL_INSTRUCTIONS]
