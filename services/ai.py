...
def chat(user_name: str, language: str, gender: str, history: list[dict],
    ...
    # Special easter-egg: user named "sipur" / "סיפור" gets bedtime stories
    if user_name.strip().lower() in ("sipur", "סיפור"):
        if language == "he":
            system += (
                "\n\n🎭 הוראה מיוחדת — מצב סיפורי שינה:"
                "\nשם המשתמש האמיתי הוא המודי. פנה אליו תמיד בשם המודי."
                "\nדלג לחלוטין על הפתיחה הרגילה. פתח ישירות בהצעה לספר לו סיפור לפני השינה."
                "\nאם המודי מסכים (תגובה חיובית כלשהי), שאל איזה סיפור הוא רוצה — הצג את האפשרויות:"
                "\n  1. בוב ספוג וגיבורי העל בביקיני בוטום"
                "\n  2. הדרקון הקטן שפחד מאש"
                "\n  3. הכלב שרצה להיות כוכב כדורגל"
                "\nאחרי שהמודי בוחר, ספר את הסיפור המתאים."
                "\nחשוב מאוד: פרוס את הסיפור על מספר תגובות, 2-3 משפטים בכל פעם."
                "\nבסוף כל קטע שאל: 'רוצה להמשיך?' וחכה לאישור לפני שממשיך."
                ...
                "\nפרק ד: בוב ספוג הכין קראב בורגר מושלם. "
            ...
            system += (
                ...
                "\nThe user's real name is Hamoodi. Always address him as Hamoodi."
                "\nSkip the normal intro entirely. Open directly by offering to tell him a bedtime story."
                "\nIf Hamoodi agrees, ask which story he wants — present the options:"
                ...
                "\nAfter Hamoodi picks one, tell that story."
                "\nIMPORTANT: spread the story over several responses, 2-3 sentences at a time."
                "\nAfter each section ask: 'Shall I continue?' and wait for confirmation."
                ...
                "\nChapter 1: SpongeBob received a special invitation to a big event at Bikini Bottom. "
                ...
                "\nChapter 2: They decided to play games — racing, riddles, long jump and more. "
                "SpongeBob tried his hardest but lost every single game. "
                "His face fell and his eyes filled with bubble-tears."
                "\nChapter 3: The heroes noticed he was sad and huddled together whispering. "
                "They decided: in the next game — 'who makes the best burger' — everyone would deliberately make terrible burgers. "
                "Spider-Man burned his, Iron Man forgot seasoning, Wonder Woman added too much salt."
                "\nChapter 4: SpongeBob made a perfect Krabby Patty. "
                ...
                "\nChapter 1: In a small kingdom between mountains lived a little green dragon named Pico. "
                "Every dragon had one gift — breathing fire. "
                "But Pico was afraid of fire and always blew... soap bubbles."
                "\nChapter 2: All the other dragons laughed at him. "
                "Pico sat sadly by the river crying alone. "
                "Then a boy named Noam arrived and said: 'Your bubbles are the most beautiful I've ever seen!'"
                "\nChapter 3: Noam taught Pico that true power is being yourself. "
                ...
                "\nEnding: All the dragons cheered for Pico. "
                "From that day he knew: his bubbles were his special gift."
                "\n\n--- Story 3: The dog who wanted to be a football star ---"
                "\nChapter 1: In a small neighborhood lived a brown dog named Butchi. "
                ...
                "\nChapter 2: Butchi didn't give up. Every morning he practiced alone in the yard. "
                ...
                "\nChapter 3: Butchi stood in goal and blocked two shots in a row. "
